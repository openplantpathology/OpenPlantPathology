...
<div class=body style = "background-color: #f6f6f6; padding: 15px; margin-bottom:40px; margin-top: 30px;">The Open Plant Pathology (OPP) initiatives support and promotes  <strong> openness, transparency and reproducibility </strong> of scientific research data and methods applied to plant pathological research and applications.
</div>
...
We strongly believe that bulding a social infrastructure through a welcoming, engaged and diverse community is key for sharing knowledge and supporting others for adoption of a new culture.
