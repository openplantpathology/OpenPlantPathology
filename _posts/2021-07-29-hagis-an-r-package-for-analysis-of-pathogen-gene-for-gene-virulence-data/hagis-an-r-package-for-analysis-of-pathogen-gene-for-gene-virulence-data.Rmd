...
{hagis} has a built in data set of 21 _P. sojae_ isolates virulence data from Michigan.
...
`sample = ` indicates the column in your data set in which the Isolate identifier is contained (_i.e._, unique isolate identifier), in this case we will use `Isolate`.
