...
More than two dozen software, most of them proprietary, have been used for measuring percent severity in phytopathometry research [@Del2017]. As far as I know, there is no specialized R package or one with functions built specific for plant disease severity measurement.
...
In this post I will demonstrate how to measure severity using the `sympmatic_area()` function of pliman to measure severity in 10 leaves (batch processing) of soybean rust. I will further compare the measures with ones determined using QUANT software as used in a previous work [@franceschi2020]
