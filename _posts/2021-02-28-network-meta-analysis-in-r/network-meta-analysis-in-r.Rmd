...
Here, I reproduce the analysis shown in a paper where the authors made available all the data (wheat yield response to fungicides), as well as SAS codes @madden2016, using an MA-specific package of R (_metafor_).
...
I will reproduce some, not all, of the arm-based models presented in the original paper using a meta-analysis-specific package called _metafor_.
