...
description: |
  In which the author revisits a previously published analysis and finds ways to improve it while using reproducible research to illustrate refitting a GAM using random effects to better the model to the data.
author:
  - name: Adam H. Sparks
...
The `mod_new` now includes these and the model fit is further improved with their inclusion. -ahs 2024-04-28
