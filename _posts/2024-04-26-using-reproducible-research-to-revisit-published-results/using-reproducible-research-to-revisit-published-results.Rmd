...
description: |
  In which the author revisits a previously published analysis and finds ways to improve it while using reproducible research to illustrate refitting a GAM using random effects to improve the model.
author:
  - name: Adam H. Sparks
...
Here we've added a new line, `s(site, rep, station, bs = "re")` for the random effects.
...
#### Original Khaliq _et al._ Model
...
- [GAMbler](https://ecogambler.netlify.app/blog/) from Nick Clark, ecology focus but has great support for GAMs.
- [From the bottom of the heap](https://fromthebottomoftheheap.net/blog/) from Ben Bolker, I already mentioned this blog at the beginning of the post, but it's worth mentioning again for the great materials that Ben has put together and shared.