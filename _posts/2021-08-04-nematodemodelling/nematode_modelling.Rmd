...
The {tidyverse} includes, {readr} [-@READR2017], used to import the data; {tidyr}
[-@TIDYR2018], used to format the data; {dplyr} [-@DPLYR2017], used to subset the data; and {ggplot2} [-@GGPLOT22009], used for visualising the data and model fits.
