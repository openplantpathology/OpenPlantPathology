...
This workshop will introduce participants to ways that R and related tools, such as RMarkdown, can be used in creating reproducible research outputs.
...
Basic familiarity with R and RStudio is required.
