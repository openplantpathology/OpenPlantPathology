...
description: |
  How to obtain leaf temperature estimates world-wide using the R packages, _tealeaves_ and _nasapower_.
author:
  - name: Paul Melloy
...
The incidence and severity of plant diseases are dependant on environmental effects which is emphasised by the [disease triangle](https://www.apsnet.org/edcenter/foreducators/TeachingNotes/Pages/DiseaseTriangle.aspx).
