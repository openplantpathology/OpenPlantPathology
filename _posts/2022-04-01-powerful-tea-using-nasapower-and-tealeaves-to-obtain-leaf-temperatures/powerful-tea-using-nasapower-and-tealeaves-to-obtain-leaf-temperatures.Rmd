...
Before I begin, it is worth noting _tealeaves_ uses the package [_units_](https://cran.r-project.org/web/packages/units/vignettes/units.html) to format the inputs and outputs.
...
In the `get_power()` function above, I have requested "NASA POWER" data from the
...
In addition I have requested hourly data for the first week in June 2021 with the 
